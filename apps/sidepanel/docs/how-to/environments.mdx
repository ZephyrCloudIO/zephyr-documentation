...
<dd>
  Enter the full URL for the custom domain. If you have configured a Cloud Provider, you can input custom domains like `sub.domain.com` without needing `https://`.
</dd>
