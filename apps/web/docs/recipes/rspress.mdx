...
Now that the initial setup is complete, you can check other cloud providers to deploy your application, or learn how to customize your environment settings.
