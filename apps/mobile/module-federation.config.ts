...
export default createModuleFederationConfig({
  ...
  exposes: {
    ...
    './react-native-bootstrapping': './docs/recipes/react-native/bootstrapping-your-native-application.mdx',
    './react-native-host': './docs/recipes/react-native/configuring-host.mdx',
    './react-native-remote': './docs/recipes/react-native/configuring-remote.mdx',
    './react-native-ios': './docs/recipes/react-native/rspack-ios-setup.mdx',
    './react-native-state': './docs/recipes/react-native/state-manager-sharing-between-react-native-applications.mdx',
