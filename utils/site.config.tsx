...
export const SiteConfig: CardProps = {
    start: [
        {
            ...
            "description": "Have an overview of modern application's development complexity and how Zephyr can speed up the process.",
            "href": "/guide/getting-started/why-zephyr-cloud",

        },
        {
            title: "Installation",
            description: "The quickest way to get you started with our chrome extension, dashboard and npm package. Use Webpack as an example. ",
            href: "/guide/getting-started/installation",
            variant: "small"
        },
        {
            "title": "Adding Zephyr to existing application",
            "description": "One line of code to add Zephyr to your existing application. Use Nx + React + Webpack as an example.",
    ...
    features: [
        {
            ...
            description: "Zephyr provides version control for your application and enabling your application to rollback and forward on chrome extension.",
            href: "/features/version-control",
        },
        {
            title: "Rollback and forward",
            description: "Zephyr provides rollback and forward features for your application.",
        ...
        },
        {
            ...
            description: "Zephyr provides long-lived preview links for your application.",
            href: "/features/long-lived-preview-links",
        },
        {
            title: "Dependency management",
            description: "Zephyr provides dependency management for your application.",
    ...
    recipes: [
        ...
        },
        {
            ...
            variant: "small",
            icons: [<ReactIcon />, <NxIcon />, <RspackIcon />, <ModuleFederationIcon />]
        },
        {
            ...
            variant: "small",
            icons: [<ReactIcon />, <WebpackIcon/>, <NxIcon />, <ModuleFederationIcon />]
        },
        {
            ...
            variant: "small",
            icons: [<ReactIcon />, <WebpackIcon />, <LernaIcon/>,<ModuleFederationIcon />]
        },

        {
            // qwik-1.5
            title: "Qwik + Netlify",
            description: "Adding Zephyr to Vite config in a Qwik app scaffolded by Qwik city - deploy to Netlify.",
