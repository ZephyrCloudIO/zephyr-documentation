...
export const Card = ({ item }: { item: CardItemProps }) => {
  return (
    ...
    >
      <div
        className={cn(
          "group relative rounded-md bg-[var(--rp-c-bg-muted)] overflow-hidden px-[0.6px] pb-[1.02px] pt-[1px] lg:hover:!opacity-100 transition-all lg:group-hover/list:opacity-70",
        )}
      >
