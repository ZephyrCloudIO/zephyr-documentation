                    ...
                    return (
                        <tr key={i} className={"p-4 border-b border-zinc-200/20"}>
                            <td className="flex items-start justify-start py-2 text-start">
                                <p  className={"pl-2 pt-1 pb-2 pr-3  hover:underline-offset-4 hover:underline hover:decoration-dashed hover:decoration-[var(--rp-c-brand)]/40 text-[var(--rp-c-brand)] hover:text-zinc-100 transition-all"}>
