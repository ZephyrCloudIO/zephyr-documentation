...
<dd>
  ...
  project](https://developers.cloudflare.com/pages). This field will become the name of your Cloudflare Pages project.
</dd>
...
Visit our [recipes](/recipes) to test an application. Your next deployment should use your designated domain! (If not, [contact us](https://zephyr-cloud.io/discord)).
