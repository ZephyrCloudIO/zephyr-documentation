...
#### 5. Configure advanced certificate (required if you want to use domains like `*.ze.your.domain`)
...
<dt>Delimiter</dt>
<dd>The delimiter for application subdomains - **- (*-ze.your.domain)** or **. (*.ze.your.domain)**</dd>
