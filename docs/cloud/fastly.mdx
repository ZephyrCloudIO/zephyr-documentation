...
### Log in and open the Fastly integration
...
After signing in, select your organization. Go to **Settings > Deployment Integrations**, select **Add integration**, and choose **Fastly**.
...
1. In Fastly, open **Security > TLS management > Subscriptions** and select **Secure another domain**.
