...
- Create your API token [here](https://manage.fastly.com/account/personal/tokens).
- For detailed steps on creating an API token, refer to the [Fastly API token documentation](https://www.fastly.com/documentation/guides/account-info/account-management/using-api-tokens/).
...
2. Add the verification CNAME record from the fastly Subscription Details page. [**Step 6 of the previous section**](/cloud/fastly#configure-dns-domain)
