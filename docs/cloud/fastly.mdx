...
- A Fastly site project with a [custom domain](/fastly-domain) configured
- A registered domain
...
3. During deployment:
   ...
   - Application Tags are created in Zephyr (viewable on Application settings page)
   - Separate ze-env is created for each tag