...
<dd>
  ...
  new one (default integration) is set. Deploy with integration won't work until Akamai worker and property become activated.
</dd>
...
Can be done with [Akamai CLI](https://github.com/akamai/cli-edgeworkers/blob/master/docs/edgekv_cli.md#revoke-access-token) or [Akamai API](https://techdocs.akamai.com/edgekv/reference/delete-namespace).
