...
In the land of Micro-Frontend and how Zephyr deploy applications, we map each individual components and serve them with edge functions via the wildcards of one domain. 
...
[Read more about subdomain in Netlify's Documentation](https://docs.netlify.com/domains-https/custom-domains/configure-external-dns/#configure-a-subdomain).
