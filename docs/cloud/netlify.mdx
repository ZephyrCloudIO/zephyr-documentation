...
head:
  - - meta
    - property: og:description
      content: Configuring Netlify as your deployment integration provider on Zephyr
---
...
- If you faced issues while deploying Micro-frontend application, you can follow your complete guide on [how to deploy Micro-frontend applications on Zephyr](/tutorials/mf-guide).
