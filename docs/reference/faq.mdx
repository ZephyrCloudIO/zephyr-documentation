...
You can see a [Managing Cloud Providers](/cloud) here. If you don't see your cloud provider, or you have specific CI requirement, remember to jump in our [Discord](https://discord.gg/zephyrcloud) server to let us know!

:::

:::details{title="How do I connect custom cloud providers with Zephyr?"}

You can start with this guide [Managing Cloud Providers](/cloud) to find out more and choose a Cloud provider to start with. If you run into any problems, welcome to jump into our [Discord Server](https://discord.gg/zephyrcloud) and we will help you out. 😊
