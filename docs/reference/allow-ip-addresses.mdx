---
title: Allow IP Addresses
description: Configure your origin server to allow Zephyr Cloud IP addresses for BYOC deployments and private network setups.
head:
  - - meta
    - property: og:description
      content: Configure your origin server to allow Zephyr Cloud IP addresses for BYOC deployments and private network setups.
---
