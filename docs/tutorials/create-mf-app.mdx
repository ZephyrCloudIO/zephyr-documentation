...
head:
  - - meta
    - property: og:description
      content: Zephyr Cloud Documentation - Creating a basic module federation app and deploy it through Zephyr.
---
...
We conducted tests using React, but other frameworks may also be compatible. See the [Module Federation guide](/tutorials/mf-guide) for more details on supported frameworks.
...
While both packing options are viable, we strongly recommend **[Rspack](/bundlers/rspack)** for its performance. See [benchmark of Rspack](https://www.rspack.dev/).
...
Your application will be automatically available at the provided Zephyr URL. Each deployment creates a new [version](/features/versions) of your application with its own permanent URL.
