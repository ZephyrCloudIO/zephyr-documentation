...
An example working shell app's configuration can be seen below as well as [in our example repository](https://github.com/ZephyrCloudIO/zephyr-examples/tree/main/module-federation/react-webpack). For detailed bundler-specific configurations, see our [bundler guides](/bundlers/rspack).
