---
title: Micro-Frontends with Zephyr - The Complete Guide
description: Learn how to configure, build, and deploy Micro-Frontends with Module Federation using Zephyr Cloud. This complete guide covers configuration setup, dependency resolution, circular dependency management, and deployment best practices.
head:
  - - meta
    - property: og:description
      content: Learn how to configure, build, and deploy Micro-Frontends with Module Federation using Zephyr Cloud. This complete guide covers configuration setup, dependency resolution, circular dependency management, and deployment best practices.
---
