...
description: Learn how to implement end-to-end testing for both basic and federated applications using Zephyr. This tutorial covers extracting deployment URLs from CI builds, testing federated remotes with session storage overrides, and testing in production environments.
head:
  - - meta
    - property: og:description
      content: Learn how to implement end-to-end testing for both basic and federated applications using Zephyr. This tutorial covers extracting deployment URLs from CI builds, testing federated remotes with session storage overrides, and testing in production environments.
---
...
You can proceed to test this URL directly. [Check our guide to promote this URL directly under an environment here](/features/tags-environments).
