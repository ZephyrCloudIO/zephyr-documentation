...
If you are curious to read more about us, you can dive into our [architecture](/introduction/architecture), [recipes](/recipes) (for more frameworks and bundlers) and [features](/usage). Below guide is written based on Google Chrome thus other browser's behavior might differ (see a list of [supported browsers](/reference/supported#supported-browser))
