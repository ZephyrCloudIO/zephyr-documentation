...
<sub id="footnote-1">1. Additional functionalities are currently under development</sub>
<sub id="footnote-2">2. Based on internal benchmarks. Initial deployment time may vary.</sub>
</div>