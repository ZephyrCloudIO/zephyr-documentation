...
This is often done to test for regressions but can also be used to validate that acceptance criteria has been met.

# Testing Basic Applications
The Zephyr build output provides a link to the immutable version that was created and published as part of the build.
If you have not set up an environment that will automatically get this version you can proceed testing this URL itself.
