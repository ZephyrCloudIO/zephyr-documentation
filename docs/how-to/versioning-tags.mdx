...
Applications deployed through Zephyr can have an unlimited number of versions. After you configure Zephyr's npm plugin in your build tool, or bundlers, _**each successful deployment would generate a new version**_. Check [here to see how tags are created](#how-tags-are-created) and [how versions, tags and environments work together](#).
