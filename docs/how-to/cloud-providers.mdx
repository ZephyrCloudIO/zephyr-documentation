...
3. Go back to the Workers & Pages main page and find the **Cloudflare integration name** when you create the integration on Zephyr dashboard. Choose the project and select **Manage** on the top when you are in the project. Click on the **Delete** button. 
