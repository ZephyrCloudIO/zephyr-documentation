...
:::info 
This guide is recommended for users bring-your-own-cloud(BYOC) and using our managed cloud. Zephyr Cloud leverages many other IP ranges for various product and services but some of these address will not make connections to your origin. 
::: 
