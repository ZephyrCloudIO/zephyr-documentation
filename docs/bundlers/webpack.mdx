...
>
  <Tab>```bash pnpm add --dev zephyr-webpack-plugin ```</Tab>
  <Tab>```bash bun add --dev zephyr-webpack-plugin ```</Tab>
  <Tab>```bash yarn add --dev zephyr-webpack-plugin ```</Tab>
  <Tab>```bash npm install --save-dev zephyr-webpack-plugin ```</Tab>
</Tabs>
