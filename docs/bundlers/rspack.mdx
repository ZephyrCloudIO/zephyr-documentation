...
>
  <Tab>```bash pnpm add --dev zephyr-rspack-plugin ```</Tab>
  <Tab>```bash bun add --dev zephyr-rspack-plugin ```</Tab>
  <Tab>```bash yarn add --dev zephyr-rspack-plugin ```</Tab>
  <Tab>```bash npm install --save-dev zephyr-rspack-plugin ```</Tab>
</Tabs>
