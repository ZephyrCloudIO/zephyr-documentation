---
title: BU10010 - package.json not found 
descriptionn: Zephyr Error - BU10010 - `package.json` not found from current directory or context
# head: 
#   - - meta
#     - name: og:title
#       content: Zephyr Error - BU10010 - package.json not found from current directory
#   - - meta
#     - name: og:url 
#       content: https://docs.zephyr-cloud.io/guide/error/bu10010
---
