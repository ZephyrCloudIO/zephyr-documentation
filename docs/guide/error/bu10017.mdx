...
Related error: [DE20012 - `application_uid` is required](/guide/error/de20012)
...
If the local configuration doesn't exists, we then won't be able to generate a `build id` unique to each of your build. Note that in some scenario you might still be able to run a build - but your deployed url might show you [DE20012 - `application_uid` is required](/guide/error/de20012).
...
- [BU10010 - `package.json` not found](/guide/error/bu10010)
- [BU10011 - `package.json` is not a valid json format](/guide/error/bu10011)
- [BU10012 - `package.json` must have a name and version field](/guide/error/bu10012)

2. Make sure you have git remote origin url, git username, email configured. 

- [BU10014 - Git remote origin is not configured properly](/guide/error/bu10014)
- [BU10015 - Git username or email is not configured](/guide/error/bu10015)
- [BU10016 - Could not get git info](/guide/error/bu10016)
