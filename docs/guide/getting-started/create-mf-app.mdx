# Create MF App
Created by Module Federation [author](https://module-federation.myshopify.com/products/practical-module-federation) and technology [YouTuber](https://www.youtube.com/@jherr),
...
```
### Installing Zephyr
Install the `zephyr-edge-contract` and `zephyr-webpack-plugin`.
...
Add both packages as a dependency to your `package.json`.
...
module.exports = withZephyr()({"existing config"});
```
