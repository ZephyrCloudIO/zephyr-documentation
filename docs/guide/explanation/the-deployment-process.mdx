...
When added to your bundler's plugin list, the plugin deploys your bundled applicatioon to a remote Zephyr Cloud instance.
...
### Fact gathering
The bundler plugin first attempts to gather facts about the application.
