---
title: Manage Cloud Providers on Zephyr
...
## Add Cloudflare as your cloud provider 
...
### Find Cloudflare under in **Deployment Integration**
...
**1. Zone ID**
- You can configure your API token by selecting a domain on **Websites** once you sign into Cloudflare. 
...
<dt>API token</dt>
<dd>Obtained from Cloudflare. The [instruction above](#how-to-get-credentials-from-cloudflare) should walk you through how to get your API token.</dd>
<dt>Zone ID</dt>
