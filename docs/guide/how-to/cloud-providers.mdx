...
Once you finish your first deployment on Cloudflare, On your cloudflare account's main dashboard page, you can click on **Workers & Pages** and then **KV** to inspect your assets by clicking on **View** next to `ze_files`. 
