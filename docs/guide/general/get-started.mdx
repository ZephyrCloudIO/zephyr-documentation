...
Within your terminal you will see a new version of your deployed URL as well as a 

You will see the new version of your ap both in the console output and under **Version** dropdown in on Chrome Extension.
