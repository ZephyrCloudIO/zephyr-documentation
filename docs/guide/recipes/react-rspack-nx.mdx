...
## Pre-requisites
- You have a Zephyr Cloud account registered either from our [dashboard](https://app.zephyr-cloud.io) or [Chrome Extension](https://chromewebstore.google.com/detail/zephyr-mission-control/liflhldchhinbaeplljlplhnbkdidedn)
- Node version: >20
- npm version: >18
- You have one of your [supported browser](/guide/supported) installed
