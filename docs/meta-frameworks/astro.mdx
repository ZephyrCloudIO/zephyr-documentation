---
title: Astro
description: Deploy your Astro static sites to Zephyr Cloud with seamless integration. Learn how to configure the Astro integration for lightning-fast content-first websites.
head:
  - - meta
    - property: og:description
      content: Deploy your Astro static sites to Zephyr Cloud with seamless integration. Learn how to configure the Astro integration for lightning-fast content-first websites.
---
