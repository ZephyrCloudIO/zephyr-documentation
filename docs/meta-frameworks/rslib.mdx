...
<PackageManagerTabs
  command={{
    npm: 'npm install --save-dev zephyr-rsbuild-plugin',
    yarn: 'yarn add --dev zephyr-rsbuild-plugin',
    pnpm: 'pnpm add -D zephyr-rsbuild-plugin',
    bun: 'bun add --dev zephyr-rsbuild-plugin',
  }}
/>
