...
>
  <Tab>```bash pnpm add --dev zephyr-rsbuild-plugin ```</Tab>
  <Tab>```bash bun add --dev zephyr-rsbuild-plugin ```</Tab>
  <Tab>```bash yarn add --dev zephyr-rsbuild-plugin ```</Tab>
  <Tab>```bash npm install --save-dev zephyr-rsbuild-plugin ```</Tab>
</Tabs>
