...
```ts filename="vite.config.ts" {3,9}
...
On your browser, click on chrome extension**Zephyr Mission Control** <ChromeExtension/>, you can see your application is under the dropdown menu:
