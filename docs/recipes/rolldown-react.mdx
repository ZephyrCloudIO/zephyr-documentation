...
In this guide, we'll walk through creating a Rolldown application and configuring it with Zephyr's release.
...
Create a `rolldown.config.js` file in your project root with the following configuration:

```ts filename="rolldown.config.js"
