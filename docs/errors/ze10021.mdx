---
title: 'ZE10021: Insufficient permissions for dist folder'
description: 'ZE10021: Insufficient permissions to create the dist folder'
head:
  - - meta
    - property: og:description
      content: 'ZE10021: Insufficient permissions to create the dist folder'
---
