---
title: 'ZE10020: Failed to initialize Zephyr agent'
description: 'ZE10020: Failed to initialize Zephyr agent in Rollup plugin'
head:
  - - meta
    - property: og:description
      content: 'ZE10020: Failed to initialize Zephyr agent in Rollup plugin'
---
