...
#   - - meta
#     - name: og:url 
#       content: https://docs.zephyr-cloud.io/errors/ZE10017
---
...
Related error: [ZE20012 - `application_uid` is required](/errors/ZE20012)
...
If the local configuration doesn't exists, we then won't be able to generate a `build id` unique to each of your build. Note that in some scenario you might still be able to run a build - but your deployed url might show you [DE20012 - `application_uid` is required](/errors/ZE20012).
