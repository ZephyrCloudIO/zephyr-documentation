---
title: Vite + Webpack + Rspack with Module Federation
description: Deploy Micro-Frontend applications using Module Federation with Vite, Webpack, and Rspack. Complete guide to configuring host and remote apps with Zephyr.
head:
  - - meta
    - property: og:description
      content: Deploy Micro-Frontend applications using Module Federation with Vite, Webpack, and Rspack. Complete guide to configuring host and remote apps with Zephyr.
---
