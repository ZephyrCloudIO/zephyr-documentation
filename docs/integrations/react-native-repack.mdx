---
title: React Native, Re.Pack and Module Federations
description: Learn how to build React Native apps with Re.Pack and Module Federation, enabling code sharing between apps with Zephyr Cloud integration.
head:
  - - meta
    - property: og:description
      content: Learn how to build React Native apps with Re.Pack and Module Federation, enabling code sharing between apps with Zephyr Cloud integration.
---
...
![platform-tag](/repack/platform-resolve.webp)
