...
head:
  - - meta
    - property: og:description
      content: Zephyr Cloud Documentation - Get started guide
---
...
To understand why these configuration are necessary - [Read the complete checklist to deploy Micro-Frontend with Zephyr](/tutorials/mf-guide).
...
<Image src="/dashboard-main.webp" size="large" />
