---
title: React + Vite
description: Create and deploy a React app using Vite for bundling with the Zephyr plugin. Quick setup guide with step-by-step configuration.
head:
  - - meta
    - property: og:description
      content: Create and deploy a React app using Vite for bundling with the Zephyr plugin. Quick setup guide with step-by-step configuration.
---
...
<SourceCode href="https://github.com/ZephyrCloudIO/zephyr-examples/tree/main/bundlers/react-vite" />
...
<Image src="/react-vite-ts-side-panel.webp" />
