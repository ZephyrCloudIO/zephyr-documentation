...
Enterprise organizations can also share one subscription across multiple Zephyr organizations with [Multi-Organization Subscriptions](/features/multi-organization-subscriptions).
...
Enterprise organizations can invite child organizations to share the same subscription. See [Multi-Organization Subscriptions](/features/multi-organization-subscriptions) for setup and requirements.
