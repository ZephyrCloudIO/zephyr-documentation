...
- `https://john-doe-42-header-component-ecommerce-abc123-ze.zephyr-cloud.io`
- `https://jane-smith-156-shopping-cart-monorepo-def456-ze.zephyr-cloud.io`
...
This resolution system ensures your dependencies are predictable and your application always loads the correct versions of remote modules. For more details on how remote dependencies are resolved and managed, see [Remote Dependencies](/features/remote-dependencies).
