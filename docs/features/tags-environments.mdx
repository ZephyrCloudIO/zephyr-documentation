...
Tag conditions be **nested**, allowing deeply flexible and expressive logic trees using combinations of `AND` and `OR` groups.
...
This rule means:  
**“Select CI builds from the main or release branches made by Luciano or the QA team.”**
