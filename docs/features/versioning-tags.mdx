...
You can read more about [how tag rules are created](#how-tags-are-created) and [how to create an environment to have a custom domain](/features/environments) in other sections of our documnetation.
...
If you want to rollback or roll-forward a version towards a custom domain, you can know more by walking through [how to configure custom domain on Zephyr](/features/environments).
